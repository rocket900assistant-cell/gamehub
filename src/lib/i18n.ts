...
const D: Record<string, Entry> = {
  ...
  'friends.addHint': {
    ru: 'Отправьте заявку на приглашение',
    en: 'Send a friend request',
  },
  'friends.username': { ru: 'Имя пользователя', en: 'Username' },
  'friends.addBtn': { ru: 'Добавить', en: 'Add' },
  'friends.orLink': { ru: 'или по ссылке', en: 'or by link' },
  'friends.shareLink': { ru: 'Поделиться ссылкой', en: 'Share link' },
  'friends.requests': { ru: 'Заявки в друзья', en: 'Friend requests' },
  'friends.accept': { ru: 'Принять', en: 'Accept' },
  'friends.decline': { ru: 'Отклонить', en: 'Decline' },
  'friends.emptyTitle': { ru: 'Пока никого нет', en: 'No friends yet' },
  'friends.emptyHint': { ru: 'Добавьте друга по имени пользователя или ссылке', en: 'Add a friend by username or link' },
  'friends.removeTitle': { ru: 'Удалить из друзей?', en: 'Remove friend?' },
  // friend-request results (toast)
  'friends.res.sent': { ru: 'Заявка отправлена', en: 'Request sent' },
  'friends.res.accepted': { ru: 'Теперь вы друзья', en: "You're now friends" },
  'friends.res.exists': { ru: 'Заявка уже отправлена', en: 'Request already sent' },
  'friends.res.alreadyFriends': { ru: 'Вы уже друзья', en: 'Already friends' },
  'friends.res.notfound': { ru: 'Пользователь не найден', en: 'User not found' },
  'friends.res.self': { ru: 'Нельзя добавить себя', en: "You can't add yourself" },
  // history
  ...
  'match.rematchWaiting': { ru: 'Ждём…', en: 'Waiting…' },
  'match.rematchOffered': { ru: 'Предложен реванш', en: 'Rematch offered' },
  'match.rematchDeclined': { ru: 'Соперник отказался от реванша', en: 'Opponent declined the rematch' },
  'common.yes': { ru: 'Принять', en: 'Accept' },
  'common.no': { ru: 'Отклонить', en: 'Decline' },
  ...
  'durak.rematchNoGram': { ru: 'Мало GRAM', en: 'Low GRAM' },
  'durak.tableClosed': { ru: 'Стол закрыт', en: 'Table closed' },
  'durak.rematchHint': { ru: 'Нажми «Готов» для новой партии', en: 'Press «Ready» for a new round' },
